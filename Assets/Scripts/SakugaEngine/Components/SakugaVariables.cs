...
{
    public class SakugaVariables : MonoBehaviour
    {
        [Header("Main")]
        public int MaxHealth = 10000;
        public int MaxSuperGauge = 10000;

        [Header("Extra Variables")]
        [SerializeField] protected ExtraVariable[] ExtraVariables;

        [HideInInspector] public int CurrentHealth;
        [HideInInspector] public int CurrentSuperGauge;
        [HideInInspector] public sbyte SuperArmor;
