...
{
    public partial class StanceManager : MonoBehaviour
    {
        private SakugaFighter owner;

        public int DefaultStance = 0;
        public FighterStance[] Stances;

        [HideInInspector] public int CurrentStance;
        [HideInInspector] public int BufferedMove = -1;
        [HideInInspector] public int CurrentMove = -1;
        [HideInInspector] public bool CanMoveCancel;
        ...
        public void ExecuteMove()
        {
            ...
            Debug.Log("You executed " + GetCurrentMove().MoveName + "!");
        }
        ...
        public void AttackBufferStorage()
        {
            if (BufferedMove >= 0)
            {
                ...
                else if (!owner.HitStop.IsRunning())
                {
                    ...
                    else Debug.Log("Move " + GetMove(BufferedMove).MoveName + " Buffered!");
                }
            }
        }
