...
{
    public partial class GameMonitor : MonoBehaviour
    {
        ...
        [HideInInspector] public bool RoundIsRunning;

        [HideInInspector] public int[] VictoryCounter;

        [HideInInspector] public Global.FadeScreenMode FadeMode;
        [HideInInspector] public int FadeScreenIntensity;
        [HideInInspector] public int FadeTime;
        [HideInInspector] public int FadeProgress;
        ...
        public void CheckVictoryConditions()
        {
            ...
            else
            {
                ...
                Debug.Log($"Player {biggerHealth + 1} win the round {CurrentRound + 1}!");
            ...
            else Debug.Log($"Player {Winner + 1} win the game!");
        }
