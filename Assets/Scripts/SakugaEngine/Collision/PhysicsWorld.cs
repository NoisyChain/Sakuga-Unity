...
namespace SakugaEngine.Collision
{
    public class PhysicsWorld
    {
            ...
            for (int st = 0; st < Steps; st++)
            {
                ...
                for (int i = 0; i < bodies.Count; i++)
                {
                    ...
                    for (int j = i + 1; j < bodies.Count; j++)
                    {
                        ...
                        {
                            Vector2Int depth = GetDepth(bodyA.Pushbox, bodyB.Pushbox);
			...
			{	
				...
				for (int j = 0; j < bodyB.Hitboxes.Length; j++)
				{
					...
					if (hitboxA.IsOverlapping(hitboxB))
					{
                        ...
                        Vector2Int ContactPoint = GetContactPoint(hitboxA, hitboxB);
        ...
        private void HitQueries()
        {
            ...
            for (int i = 0; i < hitQueries.Count; i++)
            {
                ...
                if (currentHit.p1HitType == 0 && currentHit.p2HitType != 0) {
                    ...
                    currentHit.p2.HitboxClash(currentHit.p2Hitbox, Vector2Int.zero);
                }
        ...
        public Vector2Int GetContactPoint(Collider A, Collider B)
        {
        ...
        public Vector2Int GetDepth(Collider A, Collider B)
        {
            Vector2Int length = A.Center - B.Center;

            Vector2Int Depth = (A.Size + B.Size) / 2;
    ...
    public struct HitQuery
    {
        ...
        public Vector2Int p1ContactPoint;
        public IDamage p2;
        public int p2HitType;
        public HitboxElement p2Hitbox;
        public Vector2Int p2ContactPoint;
    }
}
